...
Simpler alternative to LSTM with fewer parameters and faster training
"""
...
class GRUTrajectoryModel:
    """GRU model for trajectory prediction - simpler and faster than LSTM"""
    ...
    def __init__(self, config: Dict = None):
        ...
        self.config = {
            ...
            'gru_units': [64, 32],  # Stacked GRU layers
            'dense_units': [32],    # Dense layers
            'dropout_rate': 0.2,    # Lower dropout than LSTM
            'recurrent_dropout': 0.1,
            'l2_regularization': 0.0005,  # Less regularization
            'learning_rate': 0.001,
            'batch_size': 32,
            'epochs': 80,
    ...
    def train(self, X_train: np.ndarray, y_train: np.ndarray, 
        ...
        """
        print(f"[TRAINING] Training GRU model...")
    ...
    def evaluate(self, X_test: np.ndarray, y_test: np.ndarray, 
        ...
        print("[DATA] Evaluating GRU model...")
